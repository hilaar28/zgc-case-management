...
const { USER_ROLES, GENDER, MARITAL_STATUS, CASE_SOURCES } = require('../../constants');
 ...
 * @param {class} Model 
 * @param {String} attr 
 * @returns {Promise<import { Model } from "mongoose">}
 */
function findLastInserted(Model, attr='id') {
